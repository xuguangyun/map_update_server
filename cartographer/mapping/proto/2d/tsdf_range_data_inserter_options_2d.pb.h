...
#ifndef PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2f2d_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto
#define PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2f2d_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_cartographer_2fmapping_2fproto_2f2d_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_cartographer_2fmapping_2fproto_2f2d_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto {
...
class TSDFRangeDataInserterOptions2D final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TSDFRangeDataInserterOptions2D) */ {
 public:
  ...
  TSDFRangeDataInserterOptions2D* New(::google::protobuf::Arena* arena) const final {
  ...
  void clear_update_weight_angle_scan_normal_to_ray_kernel_bandwith();
  static const int kUpdateWeightAngleScanNormalToRayKernelBandwithFieldNumber = 7;
  double update_weight_angle_scan_normal_to_ray_kernel_bandwith() const;
  void set_update_weight_angle_scan_normal_to_ray_kernel_bandwith(double value);

  // double update_weight_distance_cell_to_hit_kernel_bandwith = 8;
  void clear_update_weight_distance_cell_to_hit_kernel_bandwith();
  static const int kUpdateWeightDistanceCellToHitKernelBandwithFieldNumber = 8;
  double update_weight_distance_cell_to_hit_kernel_bandwith() const;
  void set_update_weight_distance_cell_to_hit_kernel_bandwith(double value);
 ...
 private:
  ...
  double update_weight_angle_scan_normal_to_ray_kernel_bandwith_;
  double update_weight_distance_cell_to_hit_kernel_bandwith_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_cartographer_2fmapping_2fproto_2f2d_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto;
};
// ===================================================================
...
// double update_weight_angle_scan_normal_to_ray_kernel_bandwith = 7;
inline void TSDFRangeDataInserterOptions2D::clear_update_weight_angle_scan_normal_to_ray_kernel_bandwith() {
  update_weight_angle_scan_normal_to_ray_kernel_bandwith_ = 0;
}
inline double TSDFRangeDataInserterOptions2D::update_weight_angle_scan_normal_to_ray_kernel_bandwith() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.TSDFRangeDataInserterOptions2D.update_weight_angle_scan_normal_to_ray_kernel_bandwith)
  return update_weight_angle_scan_normal_to_ray_kernel_bandwith_;
}
inline void TSDFRangeDataInserterOptions2D::set_update_weight_angle_scan_normal_to_ray_kernel_bandwith(double value) {
  
  update_weight_angle_scan_normal_to_ray_kernel_bandwith_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.TSDFRangeDataInserterOptions2D.update_weight_angle_scan_normal_to_ray_kernel_bandwith)
}

// double update_weight_distance_cell_to_hit_kernel_bandwith = 8;
inline void TSDFRangeDataInserterOptions2D::clear_update_weight_distance_cell_to_hit_kernel_bandwith() {
  update_weight_distance_cell_to_hit_kernel_bandwith_ = 0;
}
inline double TSDFRangeDataInserterOptions2D::update_weight_distance_cell_to_hit_kernel_bandwith() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.TSDFRangeDataInserterOptions2D.update_weight_distance_cell_to_hit_kernel_bandwith)
  return update_weight_distance_cell_to_hit_kernel_bandwith_;
}
inline void TSDFRangeDataInserterOptions2D::set_update_weight_distance_cell_to_hit_kernel_bandwith(double value) {
  
  update_weight_distance_cell_to_hit_kernel_bandwith_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.TSDFRangeDataInserterOptions2D.update_weight_distance_cell_to_hit_kernel_bandwith)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2f2d_2ftsdf_5frange_5fdata_5finserter_5foptions_5f2d_2eproto
