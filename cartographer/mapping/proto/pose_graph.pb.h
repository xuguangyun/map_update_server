...
enum PoseGraph_Constraint_Tag {
  ...
  PoseGraph_Constraint_Tag_PoseGraph_Constraint_Tag_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  PoseGraph_Constraint_Tag_PoseGraph_Constraint_Tag_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class SubmapId final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.SubmapId) */ {
 public:
  SubmapId();
  virtual ~SubmapId();
...
class NodeId final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.NodeId) */ {
 public:
  NodeId();
  virtual ~NodeId();
...
class PoseGraph_Constraint final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph.Constraint) */ {
 public:
...
class PoseGraph_LandmarkPose final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph.LandmarkPose) */ {
 public:
...
class PoseGraph final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.PoseGraph) */ {
 public:
  PoseGraph();
  virtual ~PoseGraph();
