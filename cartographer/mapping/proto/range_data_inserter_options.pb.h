...
#ifndef PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_2eproto
...
enum RangeDataInserterOptions_RangeDataInserterType {
  ...
  RangeDataInserterOptions_RangeDataInserterType_RangeDataInserterOptions_RangeDataInserterType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  RangeDataInserterOptions_RangeDataInserterType_RangeDataInserterOptions_RangeDataInserterType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class RangeDataInserterOptions final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.RangeDataInserterOptions) */ {
 public:
  ...
  RangeDataInserterOptions* New(::google::protobuf::Arena* arena) const final {
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_2eproto
