...
class FastCorrelativeScanMatcherOptions3D final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.scan_matching.proto.FastCorrelativeScanMatcherOptions3D) */ {
 public:
  ...
  FastCorrelativeScanMatcherOptions3D* New(::google::protobuf::Arena* arena) const final {
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto
