...
class Submap2D final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap2D) */ {
 public:
  Submap2D();
  virtual ~Submap2D();
...
class Submap3D final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap3D) */ {
 public:
  Submap3D();
  virtual ~Submap3D();
