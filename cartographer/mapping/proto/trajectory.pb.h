...
class Trajectory_Node final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Trajectory.Node) */ {
 public:
  Trajectory_Node();
...
class Trajectory_Submap final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Trajectory.Submap) */ {
 public:
  Trajectory_Submap();
...
class Trajectory final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Trajectory) */ {
 public:
  Trajectory();
  virtual ~Trajectory();
