...
#ifndef PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto
...
template<> ::cartographer::mapping::proto::TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D* Arena::CreateMaybeMessage<::cartographer::mapping::proto::TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D>(Arena*);
...
enum SensorId_SensorType {
  ...
  SensorId_SensorType_SensorId_SensorType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  SensorId_SensorType_SensorId_SensorType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class InitialTrajectoryPose final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.InitialTrajectoryPose) */ {
 public:
  ...
  InitialTrajectoryPose* New(::google::protobuf::Arena* arena) const final {
...
class TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryBuilderOptions.OverlappingSubmapsTrimmerOptions2D) */ {
 public:
  ...
  inline TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D* New() const final {
    return CreateMaybeMessage<TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D>(nullptr);
  }

  TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class TrajectoryBuilderOptions_PureLocalizationTrimmerOptions final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryBuilderOptions.PureLocalizationTrimmerOptions) */ {
 public:
  ...
  TrajectoryBuilderOptions_PureLocalizationTrimmerOptions* New(::google::protobuf::Arena* arena) const final {
...
class TrajectoryBuilderOptions final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryBuilderOptions) */ {
 public:
  ...
  TrajectoryBuilderOptions* New(::google::protobuf::Arena* arena) const final {
  ...
  PROTOBUF_DEPRECATED static const int kPureLocalizationFieldNumber = 3;
...
class SensorId final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.SensorId) */ {
 public:
  SensorId();
  virtual ~SensorId();
...
class TrajectoryBuilderOptionsWithSensorIds final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryBuilderOptionsWithSensorIds) */ {
 public:
  ...
  TrajectoryBuilderOptionsWithSensorIds* New(::google::protobuf::Arena* arena) const final {
...
class AllTrajectoryBuilderOptions final :
 ...
 public:
  ...
  AllTrajectoryBuilderOptions* New(::google::protobuf::Arena* arena) const final {
...
inline const ::cartographer::mapping::proto::TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D& TrajectoryBuilderOptions::overlapping_submaps_trimmer_2d() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D*>(
...
inline ::cartographer::mapping::proto::TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D* TrajectoryBuilderOptions::mutable_overlapping_submaps_trimmer_2d() {
  ...
  if (overlapping_submaps_trimmer_2d_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D>(GetArenaNoVirtual());
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto
